...
PROJECT_SCHEME = 'CHFormsDataModelSample' #
PROJECT_NAME = 'CHFormsDataModelSample.xcodeproj'
WORKSPACE_NAME = 'CHFormsDataModelSample.xcworkspace'
CONFIGURATION = 'Release' # The build configuration to use
INFOPLIST_PATH = 'CHFormsDataModelSample/CHFormsDataModelSample-Info.plist'
IPA_FILE_NAME = 'CHFormsDataModelSample.ipa'
RESIGNED_IPA_FILE_NAME = 'CHFormsDataModelSample.resigned.ipa'
DSYM_FILE_NAME = 'CHFormsDataModelSample.app.dSYM.zip'
